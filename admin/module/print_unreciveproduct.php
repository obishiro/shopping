...
$tb="purchase";
$html="<div style=\"text-align:center\"><h2>รายงาน การยังไม่ได้รับสินค้า </h2></div>";
$html.= "<table id=\"TableData\" width=\"100%\"    cellpadding=\"0\" cellspacing=\"0\" border=\"1\" bordercolor=\"#E9E9E9\"   >";
		...
		$html.= "<tbody>";
		$sql="select * from $tb where Pur_status='0' order by Pur_id desc";
...
$name="รายงานการยังไม่รับสินค้า".date("dmYHis");
