...
<html lang="en">
  <head>
    ...
    <!--[if lt IE 9]>
      <script src="<?php echo WebUrl;?>assets/js/html5shiv.js"></script>
    <![endif]-->
        ...
        <div class="container">
          ...
          <div class="nav-collapse collapse">
            ...
            <form class="navbar-form pull-right">
              <input style="width:500px"class="span2" type="text" placeholder="Search">
               
              <button type="submit" class="btn btn-info"><i></i>Search</button>
            </form>
          </div><!--/.nav-collapse -->
        </div>
      </div>
